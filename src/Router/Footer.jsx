...
const Footer = () => {
    return (
        <footer className="text-gray-600 body-font">
            <div className="flex p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center flex-col md:flex-column items-center">
                ...
                <a className="my-5 text-pink-500">example@email.com</a>
